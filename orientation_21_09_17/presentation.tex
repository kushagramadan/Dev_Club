...
\section{Software Development}
    ...
    \end{frame}
    \begin{frame}{Perks!!}
        \uncover<+->{Get Selected for competitions like \textbf{GSOC}\uncover<+->{ and get a stipend of \textit{1.5 Lakhs}}\\}
        \vspace{20px}
        \uncover<+->{Win in competitions like \textbf{Microsoft Code.fun.do} \uncover<+->{and win an all expenses paid trip!!}\\}
        \vspace{20px}        
...
\section{Getting Started}
    \begin{frame}{Learn about}
        \begin{columns}
            ...
            \column{.5\textwidth}
            \begin{figure}
                \onslide<1->{\includegraphics[width=1\linewidth]{imgs/git.png}\\}
                \onslide<2->{\includegraphics[width=1\linewidth]{imgs/cmd.png}}
            \end{figure}
        \end{columns}
    \end{frame}
